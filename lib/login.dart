...
class LoginPageState extends State<LoginPage> with SingleTickerProviderStateMixin{
  ...
  Widget ShowWaitIndicator()
  {
    switch (_mostrarIndicador)
    {
      ...
      case 1:
        ...
        break;
      case 2:
        return AnimatedIcon(icon: AnimatedIcons.menu_home, progress: _iconAnimationControler, color: Colors.green, size: 50 );
        break;
    }
  ...
  Future _getUser() async {
      ...
      await http.post(Constantes.ulrWebService,
          ...
          body: sprintf(
              Constantes.envelopeLogin, [_usuario.text, _password.text])).catchError((e) {
                setState((){
                  _mostrarIndicador = 0;
                });
